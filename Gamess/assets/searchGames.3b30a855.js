import{d as u,a as l,r as d,u as f}from"./index.d6a1f066.js";import{N as v}from"./NetFunc.6716c01f.js";var y={template:`
...
<div class="sorrys" v-if="!flag">
   ...
   <div class="so-text">SORRY \u627E\u4E0D\u5230\u8BE5\u6E38\u620F</div>
    ...
    `,setup(p){const r=u();let s=l(-1);const c=new v,e=d({lists:[]}),t=l(!0);async function m(){if(t.value===!1)return;const i="http://192.168.176.49:3300/r/searchName";s.value++;const g=i+"?subtitle="+r.query.subtitle+"&pages="+s.value,a=await c.GetUrl_searchName(g);console.log("\u8FD4\u56DE\u67E5\u8BE2\u7ED3\u679C",a),e.lists=[...e.lists,...a.msg],console.log("\u6E38\u620F\u6570\u636E",e.lists),a.msg.length===0&&(t.value=!1)}const o=f();function n(i){o.push({name:"Game",query:{id:i.id}})}return{pages:s,list:e,searchName:m,goGame:n,flag:t}}};export{y as default};
