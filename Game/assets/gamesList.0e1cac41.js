import{r as g,a as i,u}from"./index.bbadf433.js";import{N as d}from"./NetFunc.6716c01f.js";var h={template:`
    ...
    `,setup(p){const a=new d,t=g({lists:[]}),l=i(!1);let e=i(-1);async function m(){e.value++;const r="http://localhost:3300/r/list"+"?next="+e.value,n=await a.GetUrl_games(r);t.lists=[...t.lists,...n.msg],console.log("\u6E38\u620F\u6570\u636E",t.lists)}const c=u();function o(s){c.push({name:"Game",query:{id:s.id}})}return{list:t,isLoading:l,next:e,GetGames:m,goGame:o}}};export{h as default};
